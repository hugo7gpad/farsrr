#' 2014 Yearly accidents reports dataset
#'
#' @source From US NHTSA website
#'  \url{https://www.nhtsa.gov/Data/Fatality-Analysis-Reporting-System-(FARS)}
#'
#' @format A \code{tibble} with `r {nrow(accident_2014.csv.bz2)}`
#'         observations and `r {length(names(accident_2014.csv.bz2))}` columns
